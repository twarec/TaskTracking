...
public class GetTaskCommentsRangeByTaskQueryValidator : AbstractValidator<GetTaskCommentsRangeByTaskQuery>
{
    public GetTaskCommentsRangeByTaskQueryValidator()
    {
